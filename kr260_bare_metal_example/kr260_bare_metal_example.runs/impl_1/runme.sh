...
HD_PWD='/home/bartek/Programming/kr260_bare_metal_example/kr260_bare_metal_example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_bram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_bram_wrapper.tcl -notrace
