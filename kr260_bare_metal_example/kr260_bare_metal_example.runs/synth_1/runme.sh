...
HD_PWD='/home/bartek/Programming/kr260_bare_metal_example/kr260_bare_metal_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_bram_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_bram_wrapper.tcl
