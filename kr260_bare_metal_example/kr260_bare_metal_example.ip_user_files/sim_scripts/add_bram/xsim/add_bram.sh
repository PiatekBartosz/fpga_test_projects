...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_15 -L zynq_ultra_ps_e_vip_v1_0_15 -L xil_defaultlib -L axi_bram_ctrl_v4_1_9 -L xlconstant_v1_1_8 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_14 -L smartconnect_v1_0 -L axi_register_slice_v2_1_29 -L blk_mem_gen_v8_4_7 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot add_bram xil_defaultlib.add_bram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim add_bram -key {Behavioral:sim_1:Functional:add_bram} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_85c6.protoinst" -protoinst "protoinst_files/add_bram.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb add_bram.wdb xsim.dir libdpi.so)
